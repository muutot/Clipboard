...
- `s3.rs` owns AWS SigV4 request signing, paginated object listing (including decoded listing ETags), conditional writes, streaming file upload/download, ETag handling, and S3-compatible connection testing.
