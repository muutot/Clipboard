...
| Component             | Contract                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AppIcon.svelte`      | Typed `IconName` union, SVG uses `currentColor`, optional size/stroke/fill. When the `general.colorIcons` setting is enabled it renders each icon with a fixed per-icon color instead of `currentColor` (the color map lives in `AppIcon.svelte::ICON_COLORS`). Extend the union, the rendering branch, and the color map together.                                                                                                                                                                                               |
