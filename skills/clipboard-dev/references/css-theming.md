...
- `.settings-state` loading/unavailable placeholder state (centered muted text), `.readonly-hint` (muted note under disabled color settings), `.auto-save-note`, and the default pointer cursor for buttons;
