...
| Float panel window        | `src/routes/float/+page.svelte`                                     | Standalone always-on-top narrow WebviewWindow (All/Favorites tabs, click-to-copy via shared `copyClipboardItem`); opened from the main toolbar or the tray menu |
