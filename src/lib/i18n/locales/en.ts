...
const en: LocaleDefinition = {
  ...
  storage: {
    ...
    storageToolsDescription: "Search index rebuild and database maintenance",
    syncTab: "Cloud Sync",
    syncTitle: "Cloud Backup",
    syncDescription: "Back up clipboard history to the cloud via WebDAV for multi-device sync",
    syncProvider: "Provider",
    syncProviderOff: "Off",
    syncProviderWebdav: "WebDAV",
    syncProviderS3: "S3 Compatible",
    syncEndpoint: "Server URL",
    syncRemotePath: "Remote Path",
    ...
    syncDownloadFailed: "Download failed",
    syncLastSync: "Last Sync",
    syncNeverSynced: "Never synced",
    syncPendingCount: "{count} pending",
    syncLastTime: "Last: {time}",
    syncSnapshotRefreshTitle: "Refresh Sync Snapshot",
    syncSnapshotRefreshDesc:
      "Creates a new complete snapshot without deleting existing snapshots or oplogs. Recommended when the remote snapshot is missing or over 30 days old.",
    syncSnapshotRefreshNow: "Refresh Snapshot",
    syncSnapshotRefreshing: "Refreshing snapshot...",
    syncSnapshotRefreshSummary: "Snapshot refreshed: {bytesUp} KB uploaded",
    syncSnapshotRefreshFailed: "Snapshot refresh failed",
    syncStatusSuccess: "Success",
    syncStatusFailed: "Failed",
    syncBackupList: "Remote Backups",
    syncRefreshList: "Refresh List",
    syncCloudTab: "Cloud",
    syncS3Title: "S3 Configuration",
    syncS3Region: "Region",
    syncS3Bucket: "Bucket",
    syncS3AccessKey: "Access Key",
    syncS3SecretKey: "Secret Key",
    syncAdvancedTab: "Advanced",
    syncAdvancedDesc: "Oplog batching, resource limits, and a reserved retention target",
    syncAutoSync: "Auto Sync",
    syncAutoSyncDesc: "Automatically sync to remote on clipboard change",
    syncAutoSyncEnable: "Enable Auto Sync",
    syncAutoInterval: "Sync Interval",
    syncRolloverEntries: "Rollover Entries",
    syncRolloverBytes: "Rollover File Size",
    syncMaxImageBytes: "Max Image Bytes",
    syncMaxFileBytes: "Max File Bytes",
    syncMaxFiles: "Oplog Target (Not Enforced)",
    syncEntriesUnit: "entries",
    syncFilesUnit: "files",
    syncSecondsUnit: "sec",
    syncEncryption: "Encryption Password",
    syncEncryptionPlaceholder: "Leave empty for no encryption",
    ...
    iconReplaced: "Replaced icon {name}",
    iconReplaceFailed: "Failed to replace icon: {error}",
    iconReplaceTitle: "Replace Icon",
    iconReplaceFor: "Replace icon for {name}",
    iconReplaceHint: "Pick an existing icon below, or choose an image file.",
    iconReplaceClose: "Close",
    chooseFile: "Choose File",
    confirmReplace: "Confirm Replace",
    iconColApp: "App",
    iconColIcon: "Icon",
    iconColSize: "Size",
    iconColAction: "Modify",
    ...
    importAction: "Import…",
    importing: "Importing…",
    exportSuccess: "Exported to {path} ({size})",
    ...
    exportDateFrom: "Start date",
    exportDateTo: "End date",
    ...
    keyboardConfigNote: "Keyboard shortcuts are saved separately from general settings",
    resetAll: "Reset All",
    ocrEngineLabel: "OCR Engine",
    ocrModelLabel: "Model",
    ocrModelApply: "Apply",
    ocrModelInstalling: "Installing...",
    ocrModelDownload: "Install",
    ocrDetectionTitle: "Detection Parameters",
    ocrDetectionDesc:
      "Adjust text region detection parameters, affecting space and line break recognition",
    ocrScoreThreshold: "Score Threshold (score)",
    ocrBoxThreshold: "Box Threshold (box)",
    ocrUnclip: "Unclip Ratio (unclip)",
    ocrLow: "Low (more regions)",
    ocrHigh: "High (fewer regions)",
    ocrSmall: "Small (tighter regions)",
    ocrLarge: "Large (looser regions, merge spaces)",
    ocrTaskStatus: "Task Status",
    ocrTaskStatusDesc: "Current OCR queue and recognition statistics",
    statsLoading: "Reading storage statistics...",
    statsUnavailable: "Storage statistics unavailable",
    statsNote: "Statistics from current project storage",
    totalRecordsDesc: "All records in database",
    textDesc: "Plain text record count",
    linkDesc: "Link record count",
    imageDesc: "Hosted images count and size",
    imageCountUnit: "",
    fileDesc: "Hosted files count and size",
    fileCountUnit: "",
    dbDesc: "SQLite database file size",
    startupTime: "Total Startup Time",
    startupTimeDesc: "Time for app to complete initialization",
    dbOpenTime: "Database Open",
    ...
    searchAvgTimeDesc: "Average latency of all recorded searches",
    searchP95Time: "P95 Search Time",
    searchP95TimeDesc: "95% of searches complete within this time",
    searchP99Time: "P99 Search Time",
    searchP99TimeDesc: "99% of searches complete within this time",
    perfUnavailable: "Performance statistics unavailable",
    perfNote: "Startup performance is app init time; search latency requires triggering a search",
    sampleTime: "Sample time: ",
    reading: "Reading…",
    refreshNow: "Refresh now",
    processWorkingSet: "Process Working Set",
    processWorkingSetDesc: "Rust main process resident memory, the Clipboard entry in Task Manager",
    processPrivateMem: "Process Private Memory",
    processPrivateMemDesc:
      "Committed memory not shared with other processes, better for judging actual growth",
    processGroupWorkingSet: "Process Group Working Set",
    processGroupWorkingSetDesc: "Main process plus Settings/WebView child processes combined",
    systemAvailableMemory: "System Available Memory",
    systemAvailableMemoryDesc:
      "Physical memory on this machine available for the app to continue using",
    jsHeapTitle: "Settings WebView JS Heap",
    jsHeapDesc: "Only this Settings WebView, not the entire app process",
    processDetail: "Process Detail",
    processDetailDesc:
      "To determine whether memory primarily resides in the main process or WebView child processes",
    ocrModelDownloading: "Installing...",
    ocrModelNotInstalled: "Model files not installed",
    ocrModelFileCount: "files",
    memoryDiagUnavailable: "Memory diagnostics unavailable: ",
    memoryDiagLoading: "Reading memory diagnostics…",
    memoryDiagEmpty: "Memory diagnostics unavailable",
    memoryNote:
      "Data auto-refreshes every 3 seconds; working set and private memory use different measurement scopes",
    currentProfile: "Current Profile",
    open: "Open",
    nextLaunch: "On Next Launch",
    directoryTree: `├─ conf/                           ← Configuration
│  ├─ conf.json                    ← General settings
│  └─ keyboard.json                ← Keyboard shortcuts
├─ models/                         ← OCR models
├─ image/                          ← Original images
│  └─ previews/                    ← Thumbnails
├─ files/                          ← File copies
├─ icons/                          ← App icon cache
└─ data/                           ← Application data
   ├─ clipboard.sqlite3            ← Clipboard database
   ├─ clipboard.sqlite3-wal        ← Write-ahead log
   └─ search-index/                ← Full-text search index`,
    recordCountUnit: " records",
    databaseMaintenance: "Database Maintenance",
    checkDatabase: "Repair Database",
    checkingDatabase: "Checking...",
    integrityOk: "Integrity OK",
    integrityProblem: "Issues Found",
  ...
  keyboard: {
    ...
    switchFilterNext: "Switch to Next Filter",
    switchFilterPrev: "Switch to Previous Filter",
    ...
    favoriteItemDesc: "Favorite or unfavorite the current item",
    addTagDesc: "Add a tag to the selected item",
    moveSelectionDesc: "Move the selection up or down",
    switchFilterDesc: "Switch to the previous or next category filter",
    clearSelectionDesc: "Clear the current multi-selection",
    hideWindowDesc: "Hide the main window",
    viewDetailDesc: "Preview the details of the current item",
    saveItemDesc: "Save image or file locally",
  ...
  general: {
    ...
    windowTransparency: "Window Opacity",
    windowTransparencyDescription: "Applied to the window immediately",
    windowOpacityAffectsText: "Text Depends on Opacity",
    ...
    iconColorsDescription:
      "Customize the color of every interface icon; empty values fall back to the built-in palette",
    iconColorsDisabledHint: "Turn on Color Icons to edit each icon's color",
    iconColorsReset: "Reset",
    iconColorsResetAll: "Reset All",
