...
const en: LocaleDefinition = {
  ...
  storage: {
    ...
    syncTab: "Cloud Sync",
    syncTitle: "S3 Sync",
    syncDescription: "Replicate clipboard history with the S3-first v1 protocol",
    syncProvider: "Sync",
    syncProviderOff: "Off",
    ...
    syncSecretStored: "Stored; enter a value to replace",
    syncAdvancedTab: "Advanced",
    syncAdvancedDesc: "Immutable segment batching and resource size limits",
    syncAutoSync: "Auto Sync",
    syncAutoSyncEnable: "Enable Auto Sync",
    syncAutoInterval: "Sync Interval",
    syncSegmentMaxEntries: "Max Entries per Segment",
    ...
    syncEncryptionStored: "Stored; enter a value to replace",
...
└─ data/                           ← Application data
  ...
  keyboard: {
    ...
    switchFilterAll: "Switch to All",
    switchFilterText: "Switch to Text",
    switchFilterLink: "Switch to Link",
    switchFilterImage: "Switch to Image",
    switchFilterFile: "Switch to File",
    switchFilterFavorite: "Switch to Favorite",
    switchFilterDeleted: "Switch to Deleted",
  ...
  general: {
    ...
    detailDisplayModeOverlay: "Overlay Panel",
    detailDisplayModeSplit: "Split View",
    floatPanelPosition: "Float Panel Position",
    floatPanelPositionDescription: "Where the float panel first appears on screen",
    floatPanelTopLeft: "Top left",
    floatPanelTopRight: "Top right",
    floatPanelBottomLeft: "Bottom left",
    floatPanelBottomRight: "Bottom right",
    floatPanelCenter: "Center",
