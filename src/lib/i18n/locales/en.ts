...
const en: LocaleDefinition = {
  ...
  storage: {
    ...
    generalDisplayDescription: "Card secondary text, detail display mode and image preview settings",
    ...
    keyboardNavigationTab: "Navigation",
    keyboardWindowTab: "Window Control",
    keyboardSearchTab: "Search",
    keyboardOtherTab: "Other",
    keyboardItemDescription: "Shortcuts for copy, delete, favorite, edit and other item actions",
    keyboardNavigationDescription: "Shortcuts for list selection, movement and focus navigation",
    keyboardWindowDescription: "Shortcuts for showing, hiding and controlling the main window",
    keyboardSearchDescription: "Shortcuts for search box operations",
    keyboardOtherDescription: "Uncategorized or custom shortcuts",
