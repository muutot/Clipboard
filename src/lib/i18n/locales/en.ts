...
const en: LocaleDefinition = {
  ...
  detail: {
    ...
    detectedFormats: "Detected Types",
    formatPlainText: "Plain text",
    formatRichText: "Rich text",
    formatHtml: "HTML",
    formatImage: "Image",
    formatFileList: "File list",
    extension: "Extension",
    fileName: "File Name",
  ...
  general: {
    ...
    detailDisplayModeOverlay: "Overlay Slide-in",
  ...
  theme: {
    ...
    textFaintDescription: "Placeholder and disabled state text color",
