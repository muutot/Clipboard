...
const zhCN: LocaleDefinition = {
  ...
  storage: {
    ...
    keyboardFloatTab: "悬浮面板",
    keyboardFloatDescription: "悬浮面板条目鼠标点击行为",
    ...
    syncTab: "云同步",
    syncTitle: "S3 同步",
    syncDescription: "使用 S3 优先的 v1 协议复制剪贴板历史",
    syncProvider: "同步开关",
    syncProviderOff: "关闭",
    ...
    syncSecretStored: "已保存；输入新值可替换",
    syncAdvancedTab: "高级设置",
    syncAdvancedDesc: "不可变增量段分批与资源大小限制",
    syncAutoSync: "自动同步",
    syncAutoSyncEnable: "启用自动同步",
    syncAutoInterval: "同步间隔",
    syncSegmentMaxEntries: "每个增量段最大条目数",
    ...
    syncEncryptionStored: "已保存；输入新值可替换",
...
└─ data/                           ← 应用数据
  ...
  keyboard: {
    ...
    switchFilterAll: "切换到全部",
    switchFilterText: "切换到文本",
    switchFilterLink: "切换到链接",
    switchFilterImage: "切换到图片",
    switchFilterFile: "切换到文件",
    switchFilterFavorite: "切换到收藏",
    switchFilterDeleted: "切换到回收站",
    clearSelection: "清空选中",
    hideWindow: "隐藏主窗口",
    selectAll: "全选条目",
  ...
  general: {
    ...
    floatPanelPosition: "悬浮窗口位置",
    floatPanelPositionDescription: "悬浮窗口首次打开时出现在屏幕的位置",
    floatPanelTopLeft: "左上",
    floatPanelTopRight: "右上",
    floatPanelBottomLeft: "左下",
    floatPanelBottomRight: "右下",
    floatPanelCenter: "中间",
  ...
  layout: {
    ...
    shortTextHeightDescription: "单行文本或无预览条目的内容高度（不含上下内边距）",
    tallTextHeight: "长文本高度",
    tallTextHeightDescription: "带预览的多行文本条目内容高度（不含上下内边距）",
    imageHeight: "图片高度",
    imageHeightDescription: "图片条目的内容区高度（不含上下内边距）",
    searchHeight: "搜索框高度",
  ...
  floatClick: {
    title: "悬浮面板点击",
    description: "悬浮面板条目的鼠标点击行为；除无操作外每个操作只能使用一次",
    leftClick: "左键点击条目",
    leftClickDesc: "左键点击悬浮面板条目时的操作",
    rightClick: "右键点击条目",
    rightClickDesc: "右键点击悬浮面板条目时的操作",
    middleClick: "中间点击条目",
    middleClickDesc: "中键点击悬浮面板条目时的操作",
    none: "无操作",
    copy: "复制",
    copyPaste: "复制并粘贴",
    favorite: "收藏",
