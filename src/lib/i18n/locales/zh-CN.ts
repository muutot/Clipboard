...
const zhCN: LocaleDefinition = {
  ...
  storage: {
    ...
    syncSnapshotRefreshTitle: "刷新同步快照",
    syncSnapshotRefreshDesc:
      "创建新的完整快照，不删除已有快照或操作日志。远端快照缺失或超过 30 天时建议执行。",
    syncSnapshotRefreshNow: "刷新快照",
    syncSnapshotRefreshing: "正在刷新快照…",
    syncSnapshotRefreshSummary: "快照刷新完成：上传 {bytesUp} KB",
    syncSnapshotRefreshFailed: "快照刷新失败",
    ...
    syncAdvancedDesc: "操作日志分批、资源限制与预留的保留目标",
    syncAutoSync: "自动同步",
