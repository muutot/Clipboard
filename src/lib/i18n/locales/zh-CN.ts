...
const zhCN: LocaleDefinition = {
  ...
  storage: {
    ...
    generalItemsDescription: "条目操作按钮、快捷复制、复制后置顶、回收站和粘贴行为设置",
    generalDisplayDescription: "卡片显示、图片预览、列表加载和详情查看的设置",
    generalGeneralDescription: "语言、操作通知和设置界面偏好",
    generalWindowDescription: "窗口外观、毛玻璃效果、标题栏和启动行为设置",
