...
const zhCN: LocaleDefinition = {
  ...
  storage: {
    ...
    generalDisplayDescription: "卡片辅助文本、详情展示模式和图片预览设置",
    generalWindowDescription: "窗口外观、启动行为、系统集成和操作反馈设置",
    keyboardItemTab: "条目操作",
    keyboardNavigationTab: "列表导航",
    keyboardWindowTab: "窗口控制",
    keyboardSearchTab: "搜索",
    keyboardOtherTab: "其他",
    keyboardItemDescription: "条目的复制、删除、收藏、编辑等操作的快捷键",
    keyboardNavigationDescription: "列表选择、移动、聚焦切换等导航类快捷键",
    keyboardWindowDescription: "窗口唤起、显示与隐藏等窗口控制快捷键",
    keyboardSearchDescription: "搜索框相关操作的快捷键",
    keyboardOtherDescription: "未分类或自定义的其他快捷键",
