...
export interface LocaleDefinition {
  ...
  keyboard: {
    ...
    switchFilterAll: string;
    switchFilterText: string;
    switchFilterLink: string;
    switchFilterImage: string;
    switchFilterFile: string;
    switchFilterFavorite: string;
    switchFilterDeleted: string;
