...
export interface LocaleDefinition {
  ...
  storage: {
    ...
    keyboardNavigationTab: string;
    keyboardWindowTab: string;
    keyboardSearchTab: string;
    keyboardOtherTab: string;
    keyboardItemDescription: string;
    keyboardNavigationDescription: string;
    keyboardWindowDescription: string;
    keyboardSearchDescription: string;
    keyboardOtherDescription: string;
