...
export interface LocaleDefinition {
  ...
  storage: {
    ...
    syncProvider: string;
    syncProviderOff: string;
    syncProviderWebdav: string;
    syncProviderS3: string;
    syncEndpoint: string;
    ...
    syncLastTime: string;
    syncSnapshotRefreshTitle: string;
    syncSnapshotRefreshDesc: string;
    syncSnapshotRefreshNow: string;
    syncSnapshotRefreshing: string;
    syncSnapshotRefreshSummary: string;
    syncSnapshotRefreshFailed: string;
    syncStatusSuccess: string;
    syncStatusFailed: string;
    syncBackupList: string;
    syncRefreshList: string;
    syncCloudTab: string;
    syncS3Title: string;
    syncS3Region: string;
    syncS3Bucket: string;
    ...
    syncAdvancedTab: string;
    syncAdvancedDesc: string;
    syncAutoSync: string;
    syncAutoSyncDesc: string;
    syncAutoSyncEnable: string;
    syncAutoInterval: string;
    syncRolloverEntries: string;
    syncRolloverBytes: string;
    syncMaxImageBytes: string;
    ...
    syncEncryptionPlaceholder: string;
