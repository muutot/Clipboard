...
const SECTION_SEARCH_TEXT: Record<SettingsSection, readonly SettingsSearchText[]> = {
  ...
  keyboard_navigation: [i18n("storage.keyboardTab"), i18n("storage.keyboardNavigationTab"), "快捷键", "导航"],
  keyboard_window: [i18n("storage.keyboardTab"), i18n("storage.keyboardWindowTab"), "快捷键", "窗口"],
  keyboard_search: [i18n("storage.keyboardTab"), i18n("storage.keyboardSearchTab"), "快捷键", "搜索"],
  keyboard_other: [i18n("storage.keyboardTab"), i18n("storage.keyboardOtherTab"), "快捷键", "其他"],
